    ...
    <div className="thermal-receipt-container w-[58mm] max-w-[58mm] bg-white text-black font-mono text-[11px] leading-tight p-2 mx-auto shadow-sm rounded-lg border border-gray-200">
      <div className="text-center space-y-0.5 mb-2">
        ...
        {businessConfig?.tillNumber && (
          <div className="mt-1 bg-emerald-50 border border-emerald-300 py-1 px-2 rounded text-[11px] font-bold text-emerald-900">
            PAYBILL / TILL NO: {businessConfig.tillNumber}
          </div>
        )}
      </div>
